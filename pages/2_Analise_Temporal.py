...
from src.plots import plotar_linha_temporal
from src.utils import carregar_dados_mestre, exibir_filtros_padrao, AUS_DISPONIVEIS

st.title("Dinâmica Temporal: Real vs Virtual")
...
figura_linha = plotar_linha_temporal(df_plot, au_selecionada_grafico, emocao_selecionada, tipo_selecionado)
